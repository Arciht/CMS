    ...
    <main className="w-full">
      <section className="flex justify-center h-[50vh] sm:h-[70vh] w-full">
        ...
        <div className="flex gap-3 ">
          <Link href="/sign-in" variant={"default"} className="bg-gray-200 hover:bg-gra-300 transition-all duration-200 delay-100  text-black px-4 py-1 rounded"> Try it out! </Link>
      ...
      <section className="min-h-screen sm:min-h-[50vh] bg-gray-600/10 w-full flex justify-center items-center px-4">
            ...
            <p className ="text-gray-400 w-[70vh] text-center">Create and edit content with user friendly interface</p>
          </span>
          <span className="flex flex-col items-center gap-2">
            <Layers size={50}/>
            <h3 className = "text-2xl font-bold text-gray-100">Flexible Tools</h3>
            <p className ="text-gray-400 w-[70vh] text-center">Create and edit content with user friendly interface</p>
          </span>
          <span className="flex flex-col items-center gap-2">
            <Zap size={50}/>
            <h3 className = "text-2xl font-bold text-gray-100">Intuitive Editor</h3>
            <p className ="text-gray-400 w-[70vh] text-center">Create and edit content with user friendly interface</p>
          </span>
          </div>
      ...
      <section className="h-[60vh] sm:h-[50vh] w-full flex flex-col justify-center items-start">
        <div className="max-w-[50%] mx-auto space-y-3">
          ...
          <div className="flex gap-2">
              <input className="bg-zinc-800 focus:outline-none rounded px-2 py-[7px] text-sm text-gray-400" type="text" placeholder="Enter your email"></input>
